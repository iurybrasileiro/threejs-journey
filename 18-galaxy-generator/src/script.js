...
gui.add(parameters, 'size').min(0.0001).max(0.1).step(0.001)
...
gui.addColor(parameters, 'oursideColor')
...
const generateGalaxy = () => {
	...
	const colorOutside = new THREE.Color(parameters.oursideColor)
	...
	for (let i = 0; i < parameters.count; i++) {
		...
		mixeColor.lerp(colorOutside, radius / parameters.radius)

		colors[i3 + 0] = mixeColor.r
